...
import { Container } from '@/app/components/marketing/container'
...
const features = [
  ...
  },
  {
    ...
    image: '/marketing/screenshots/expenses.png',
  },
  {
    title: 'VAT handling',
    description:
      "We only sell our software to companies who don't deal with VAT at all, so technically we do all the VAT stuff they need.",
    image: '/marketing/screenshots/vat-returns.png',
  },
  {
    title: 'Reporting',
    description:
      'Easily export your data into an Excel spreadsheet where you can do whatever the hell you want with it.',
    image: '/marketing/screenshots/reporting.png',
  },
]
  ...
  return (
    ...
    >
      <Image
        ...
        src="/marketing/background-features.jpg"
        alt=""
        width={2245}
        height={1636}
        unoptimized
              ...
              <TabPanels className="lg:col-span-7">
                {features.map((feature) => (
                  <TabPanel key={feature.title} unmount={false}>
                    ...
                    <div className="mt-10 w-[45rem] overflow-hidden rounded-xl bg-white shadow-xl shadow-blue-900/20 sm:w-auto lg:mt-0 lg:w-[67.8125rem]">
                      <Image
                        className="w-full"
                        src={feature.image}
                        alt=""
