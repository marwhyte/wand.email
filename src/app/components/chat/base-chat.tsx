            ...
            {!chatStarted && (
              <div id="intro" className="mx-auto mt-[2vh] max-w-[552px]">
                ...
                <p className="mb-4 text-center text-gray-600">
                  Create stunning, responsive email templates that look great across all devices.
                </p>
              </div>
            )}
            <div
                ...
                >
                  ...
                  >
                    <textarea
                      ...
                      placeholder={
                        chatStarted
                          ? 'Describe your perfect email'
                          : 'Describe your perfect email, and optionally select a template to start from'
                      }
                      translate="no"
                    />
                    <SendButton
