...
export function SidebarLayout({
  ...
  const sidebarClasses = side === 'left' ? 'left-0' : 'right-0'
  const contentClasses = side === 'left' ? 'lg:pl-64 lg:pr-2 lg:pr-64' : 'lg:pr-64 lg:pl-2 lg:pl-64'

  return (
    <div className="relative isolate flex min-h-svh w-full bg-white max-lg:flex-col lg:bg-zinc-100 dark:bg-zinc-900 dark:lg:bg-zinc-950">
      {/* Sidebar on desktop */}
      <div className={`fixed inset-y-14 w-64 max-lg:hidden ${sidebarClasses}`}>{sidebar}</div>
      ...
      <div className={`flex flex-1 flex-col pb-2 lg:min-w-0 ${contentClasses} lg:pt-2`}>
