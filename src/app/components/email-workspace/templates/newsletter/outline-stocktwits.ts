...
<EMAIL styleVariant="outline" type="newsletter">
  ...
  <ROW>
    <COLUMN>
      ...
      <TEXT>
        Today's issue covers <b>cooling consumer prices, Intel's CEO appointment, forgotten retail favorites finding interest, and more from a busy day on Wall Street. 📰</b>
      </TEXT>
      <TEXT>
  ...
  <ROW>
    <COLUMN>
      ...
      <TEXT>
        So, how is Fintech giant Affirm navigating the current environment? We sat down with <b>CFO Rob O'Hare to answer questions directly from retail investors.</b> You don't want to miss this. 🤩 
      </TEXT>
  ...
  <ROW type="footer">
    <COLUMN>
      ...
      <TEXT>
        © 2025 The Daily Rip presented by Stocktwits
      </TEXT>
      <TEXT>
        228 Park Ave S, Suite 56681, New York, NY 10003, USA
      </TEXT>
    </COLUMN>
  </ROW>
</EMAIL>
