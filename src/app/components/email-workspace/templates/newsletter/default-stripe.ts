...
<EMAIL type="newsletter">
  ...
  <ROW>
    <COLUMN>
      <HEADING level="h1">
        Why Stripe is a leader
      </HEADING>
      <TEXT>
        Momentum for Stripe Billing continues to grow, and Stripe has now been named a Leader in <i>The Forrester Wave™: Recurring Billing Solutions, Q1 2025</i> report.
      </TEXT>
      <BUTTON>
        Read the report
      </BUTTON>
      ...
      <TEXT>
        See Forrester's evaluation of Stripe Billing and other top vendors, which includes criteria such as:
      </TEXT>
      <LIST>
        <LI><b>Extensibility:</b> Our users can easily customize their billing systems as their businesses grow—without requiring extensive technical expertise.</LI>
        <LI><b>Architecture and integration:</b> Linking Stripe Billing and Stripe Payments minimizes our customers' compatibility issues while enhancing data visibility and reporting.</LI>
        <LI><b>Security:</b> We're committed to protecting our customers' data and have invested in a range of security measures.</LI>
      </LIST>
      <TEXT>
        This new announcement follows Stripe's recognition in <i>The Forrester Wave™: Merchant Payment Providers, Q1 2024</i> report.
      </TEXT>
      <TEXT>
        Read <i>The Forrester Wave™: Recurring Billing Solutions, Q1 2025</i> report to discover why we believe Stripe Billing can help you unlock new revenue streams, adapt to market trends, and scale with ease.
      </TEXT>
      <BUTTON>
        Read the report
      </BUTTON>
  ...
  <ROW padding="36,24" type="gallery" backgroundColor="#f6f9fc" borderRadius="8">
    ...
    <COLUMN width="60%">
      <TEXT>
        Stripe Sessions is our flagship annual event where business leaders and builders gather to discuss the most important internet economy trends. Join us May 6-8, 2025, at Moscone West in San Francisco.
      </TEXT>
      <LINK align="left">
        Learn more
      </LINK>
  ...
  <ROW>
    <COLUMN>
      <TEXT fontSize="10">
        Forrester does not endorse any company or product in its research and does not advise selecting based on ratings. Information is based on available resources and opinions may change. For more details, <a href="/">read about Forrester's objectivity.</a>
      </TEXT>
    </COLUMN>
  </ROW>
