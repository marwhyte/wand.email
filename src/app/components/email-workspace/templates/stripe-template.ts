...
ROW padding=0,16,32,16 align=center maxWidth=650 backgroundColor=#f6f9fc {
  ...
  COLUMN width=50% align=right {
    SOCIALS folder="stripe" socialLinks='[
      {"icon":"twitter","url":"https://twitter.com/stripe","title":"Twitter","alt":"Twitter"},
      {"icon":"linkedin","url":"https://linkedin.com/company/stripe","title":"LinkedIn","alt":"LinkedIn"},
      {"icon":"facebook","url":"https://facebook.com/stripe","title":"Facebook","alt":"Facebook"},
      {"icon":"github","url":"https://github.com/stripe","title":"GitHub","alt":"GitHub"}
    ]'
  }
}
