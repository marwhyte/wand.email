...
ROW backgroundColor=#fcfcfc hideOnMobile=true padding=0,16,30,16 {
  COLUMN {
    LINK color=#393a3d fontSize=14 fontWeight=bold href="#" content=<p>Blog</p> textAlign=center
  }
  COLUMN {
    LINK color=#393a3d fontSize=14 fontWeight=bold href="#" content=<p>Tax Calculators</p> textAlign=center
  }
  COLUMN {
    LINK color=#393a3d fontSize=14 fontWeight=bold href="#" content=<p>Podcast</p> textAlign=center
  }
  COLUMN {
    LINK color=#393a3d fontSize=14 fontWeight=bold href="#" content=<p>Sign in</p> textAlign=center
  }
}
...
ROW backgroundColor=#F4F4EF padding=32,16,32,16 {
  COLUMN {
...
ROW backgroundColor=#F4F4EF padding=0,0,40,0 {
  COLUMN {
    ...
    TEXT color=#21262a fontSize=18 letterSpacing=-0.03em padding=24,0,24,0 content=<p>Changes this year could impact your taxes. Answer a few questions today to get the tax checklist that will get you prepared for filing.</p> textAlign=center
    BUTTON backgroundColor=#205ea3 borderRadius=5 color=#FFFFFF fontSize=20 fontWeight=bold href="#" padding=24,48,24,48 content=<p>Get my checklist</p> textAlign=center
  }
}
