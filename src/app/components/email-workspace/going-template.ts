...
const defaultConfig: Required<RequiredTemplateConfig> = {
  logoUrl: getPhotoUrl('going-logo.png', 'going'),
  colors: {
    primary: '#004449',
    secondary: '#D7FFC2',
  },
  companyName: "Scott's Cheap Flights, Inc. DBA Going",
}
...
export const goingTemplate = (config?: Partial<TemplateConfig>): Email => {
  const finalConfig: Required<RequiredTemplateConfig> = {
    ...defaultConfig,
    ...(config ?? {}),
