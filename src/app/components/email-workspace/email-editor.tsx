...
export default function EmailEditor({ email }: { email: Email }) {
  ...
  return (
    <div className="email-editor flex h-full w-full min-w-[290px] max-w-[310px] flex-col overflow-y-scroll border-l border-zinc-200 bg-white dark:border-zinc-700 dark:bg-zinc-900">
