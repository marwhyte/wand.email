...
const SocialIcons = () => {
  return (
    <>
      <IconLink icon={GitHubIcon} href="https://github.com/marwhyte" aria-label="GitHub" />
      <IconLink icon={LinkedInIcon} href="https://www.linkedin.com/in/marco-whyte/" aria-label="LinkedIn" />
    </>
  )
}
