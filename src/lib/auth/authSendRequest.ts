                ...
                <tr style="width:100%">
                  <td class="column" data-id="__react-email-column" style="width:100%">
                    <table width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="border-radius:10px">
                      <tr>
                        <td style="width:100%;padding-top:12px;padding-right:0;padding-bottom:12px;padding-left:0">
                          <h1 style="font-size:28px;text-align:left;font-weight:bold;line-height:100%;letter-spacing:normal;margin-block-start:0;margin-block-end:0">Your sign-in link</h1>
                        </td>
                      </tr>
                    </table>
                    <table width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="border-radius:10px">
                        ...
                        <td style="width:100%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:0">
                          <div align="left">
                            <a href="${url}" style="line-height:100%;text-decoration:none;display:inline-block;max-width:100%;font-weight:bold;color:#ffffff;font-size:14px;border-radius:5px;cursor:pointer;align:center;content-padding-left:24px;content-padding-right:24px;border-left:0px solid transparent;border-right:0px solid transparent;border-top:0px solid transparent;border-bottom:0px solid transparent;background-color:#52a1ff;padding-top:10px;padding-right:24px;padding-bottom:10px;padding-left:24px;padding:10px 24px 10px 24px" target="_blank">
                              <span>
                                <!--[if mso]>
                                <i style="mso-font-width:400%;mso-text-raise:15" hidden>&#8202;&#8202;&#8202;</i>
                                <![endif]-->
                              </span>
                              <span style="max-width:100%;display:inline-block;line-height:120%;mso-padding-alt:0px;mso-text-raise:7.5px">Click to sign-in to wand.email</span>
                              <span>
                                <!--[if mso]>
                    ...
                    <table width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="border-radius:10px">
                      <tr>
                        <td style="width:100%;padding-top:10px;padding-right:0;padding-bottom:10px;padding-left:0">
                          <p style="font-size:14px;line-height:120%;margin:0;color:#787878;text-align:left;overflow-wrap:break-word;word-break:break-word;letter-spacing:normal">This link will automatically detect if you have an existing account. If not, it will create a new account for you.</p>
                        </td>
                      </tr>
                    </table>
                    <table width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="border-radius:10px">
                      <tr>
                        <td style="width:100%;padding-top:10px;padding-right:0;padding-bottom:10px;padding-left:0">
                          <p style="font-size:14px;line-height:120%;margin:0;color:#787878;text-align:left;overflow-wrap:break-word;word-break:break-word;letter-spacing:normal">If you have any questions, feel free to contact our support team.</p>
                        </td>
                      </tr>
                    </table>
                    <table width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="border-radius:10px">
                      <tr>
                        <td style="width:100%;padding-top:10px;padding-right:0;padding-bottom:10px;padding-left:0">
                          <div align="left">
                            <a href="mailto:support@wand.email" style="color:#3b82f6;text-decoration:none;font-size:14px;font-weight:normal;cursor:pointer;align:center" target="_blank">Contact Support</a>
                          </div>
                        </td>
                      </tr>
                    </table>
                    ...
                    <table width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="border-radius:10px">
                      <tr>
                        <td style="width:100%;padding-top:4px;padding-right:0;padding-bottom:4px;padding-left:0">
                          <p style="font-size:14px;line-height:120%;margin:0;text-align:center;overflow-wrap:break-word;word-break:break-word;letter-spacing:normal;color:#696969">You&#x27;ve received this email because you signed up for <a href="https://wand.email" style="color:#3b82f6;text-decoration:none;font-size:14px;font-weight:normal;cursor:pointer;align:center" target="_blank">wand.email</a></p>
                        </td>
                      </tr>
                    </table>
                    <table width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="border-radius:10px">
                      <tr>
                        <td style="width:100%;padding-top:4px;padding-right:0;padding-bottom:4px;padding-left:0">
                          <p style="font-size:14px;line-height:120%;margin:0;text-align:center;overflow-wrap:break-word;word-break:break-word;letter-spacing:normal;color:#696969">209 Bluefield Rd, Chapel Hill, NC 27517</p>
                        </td>
                      </tr>
                    </table>
                  </td>
